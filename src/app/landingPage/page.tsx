    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <header className="flex items-center justify-between mb-8">
        <div className="flex items-center">
          ...
          />
          <h1 className="text-2xl font-bold">Aboki Code</h1>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
        ...
        <div className="bg-[#FDE68A] p-6 rounded-lg">
          <h2 className="text-2xl font-bold mb-2">Aboki Code</h2>
          <h3 className="text-xl font-semibold mb-4">Coding Summer Bootcamp</h3>
          <p className="mb-6">Learn to code at home - No experience required</p>
      ...
      <section className="mb-12">
        ...
        <p className="mb-8">
          Aboki code is a free coding bootcamp that takes beginners and
          ...
          potential, and be a part of the digital revolution with Aboki Code.
        </p>
      ...
      <footer className="bg-gray-900 text-white p-6 mt-8">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2024 Aboki Code. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
